...
function calcSub(){
     ...
     //if statement 
    if(document.getElementById("Multiexperience").checked) {
         argsubtotal = 500; // subtotal if Multiexperience is checked
     }  
        else if(document.getElementById("Hyperautomation").checked) {
         argsubtotal = 200; // subtotal if Hyperautomation is checked
     }     
